        ...
        <div class="product-post__wrapp">
            ...
            <div class="product-post__box">
                ...
                <div class="product-post__details">
                    ...
                    <div class="product-post__content"><?php the_content(); ?></div>
                </div>
            </div>
            ...
            <?php if ($show_more_posts): ?>
                <div class="product-post__more">
                    ...
                    $categories = get_the_terms(get_the_ID(), 'granites_category'); // Меняем на вашу таксономию, если нужно
                    ...
                    if ($category_id):
                        $related_posts = new WP_Query([
                            ...
                            'tax_query'      => [
                                [
                                    'taxonomy' => 'granites_category', // Укажите вашу кастомную таксономию
                                    'field'    => 'term_id',
                                    'terms'    => $category_id,
                                ],
                            ],
